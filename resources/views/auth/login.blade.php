...
<body class="bg-background-light dark:bg-background-dark min-h-screen flex items-center justify-center p-4 auth-page-body">
    <div class="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-hidden auth-card">
        <div class="p-8 pb-0 flex flex-col items-center text-center">
            ...
            <h1 class="text-slate-900 dark:text-slate-100 text-xl font-bold tracking-tight">Welcome back</h1>
            <p class="text-slate-500 dark:text-slate-400 text-sm mt-2">Enter your credentials to access your account</p>
        </div>
        ...
        <div class="p-8">
            <form action="{{ route('login') }}" class="space-y-5" method="POST" id="loginForm" novalidate>
                @csrf
                <div class="space-y-2">
                    <label class="text-sm font-medium leading-none text-slate-900 dark:text-slate-100 flex items-center gap-2" for="email">
                        Email
                    </label>
                    <div class="relative">
                        <input class="flex h-10 w-full rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 px-3 py-2 text-sm ring-offset-white placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-all font-display" 
                               id="email" 
                               name="email" 
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        <label class="text-sm font-medium leading-none text-slate-900 dark:text-slate-100 flex items-center gap-2" for="password">
                            Password
                        </label>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <label class="text-sm text-slate-500 dark:text-slate-400 font-normal" for="remember">Remember me for 30 days</label>
                </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <button class="flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-2 text-sm font-medium text-slate-900 dark:text-slate-100 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
        ...
        <div class="px-8 py-6 bg-slate-50 dark:bg-slate-950/50 border-t border-slate-200 dark:border-slate-800 text-center">
